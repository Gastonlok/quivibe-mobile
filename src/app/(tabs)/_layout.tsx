  ...
  return (
    <View style={styles.brand}>
      ...
      <View style={styles.city}>
        <Ionicons name="location-sharp" color={c.primaryText} size={12} />
        <Text style={styles.cityText}>KINSHASA</Text>
      </View>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  wordmark: { fontFamily: fonts.bold, fontSize: 25, color: c.text },
  city: {
    flexDirection: "row",
    alignItems: "center",
    gap: 4,
